...
- Weather-aware scheduling using your local forecast
- Weather alerts — frost, extreme heat, and plant protection warnings
- Plant identification by photo using AI
- AI health diagnosis — take a photo and get a full analysis with recommended treatment
- Diagnosis chat — ask follow-up questions about your plant's condition
- Health score for each plant and your entire garden
- Nutrient info and homemade fertilizer recipes for every plant
- Shopping list from your diagnosis treatments
...
- Programación inteligente basada en el pronóstico del tiempo
- Alertas de clima — heladas, calor extremo y protección de plantas
- Identificación de plantas por foto con IA
- Diagnóstico de salud — sacale fotos a tu planta y recibí un análisis completo con tratamiento recomendado
- Chat de diagnóstico — consultá sobre el estado de tu planta
- Puntaje de salud para cada planta y tu jardín completo
- Info de nutrientes y recetas caseras de fertilización
- Lista de compras generada desde los tratamientos del diagnóstico
- Tus datos se guardan en tu dispositivo — privacidad por defecto
...
**English (98 chars):**
```
plant,watering,reminder,identifier,diagnosis,houseplant,succulent,weather,tracker,fertilizer,AI
```

**Español (99 chars):**
```
plantas,riego,recordatorio,identificar,diagnóstico,suculentas,macetas,clima,huerto,fertilizante
```

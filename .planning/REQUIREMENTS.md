...
- [x] **PROB-01**: When AI diagnoses a problem, user can create a tracked problem record for that plant (premium only)
...
- [x] **PROB-05**: When a follow-up diagnosis shows improvement, AI suggests resolution and user confirms with one tap
...
- [x] **PROB-08**: Follow-up re-diagnosis opens a new chat session (not same thread)

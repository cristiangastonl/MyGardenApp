...
- [ ] **Phase 10: Perenual Security** — Move Perenual API key server-side via new `get-plant-care` edge function; rotate key; remove from client bundle
...
| 10. Perenual Security | v1.2 | 0/TBD | Not started | - |
